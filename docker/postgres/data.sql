...
VALUES
(gen_random_uuid(), 'admin01', 'password1', 'admin@woodify.com', 'Admin User', '0901000001', (SELECT role_id FROM roles WHERE role_name = 'Admin' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'staff01', 'password2', 'staff01@woodify.com', 'Staff User', '0901000002', (SELECT role_id FROM roles WHERE role_name = 'Staff' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'support01', 'password3', 'support01@woodify.com', 'Support One', '0901000003', (SELECT role_id FROM roles WHERE role_name = 'Support' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'support02', 'password4', 'support02@woodify.com', 'Support Two', '0901000004', (SELECT role_id FROM roles WHERE role_name = 'Support' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'seller01', 'password5', 'seller01@gmail.com', 'Nguyễn Văn Seller', '0901000005', (SELECT role_id FROM roles WHERE role_name = 'Seller' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'seller02', 'password6', 'seller02@gmail.com', 'Trần Thị Seller', '0901000006', (SELECT role_id FROM roles WHERE role_name = 'Seller' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'customer01', 'password7', 'customer01@gmail.com', 'Lê Văn Customer', '0901000007', (SELECT role_id FROM roles WHERE role_name = 'Customer' LIMIT 1), Now(), Now(), TRUE),
(gen_random_uuid(), 'customer02', 'password8', 'customer02@gmail.com', 'Phạm Thị Customer', '0901000008', (SELECT role_id FROM roles WHERE role_name = 'Customer' LIMIT 1), Now(), Now(), TRUE)
ON CONFLICT DO NOTHING;
