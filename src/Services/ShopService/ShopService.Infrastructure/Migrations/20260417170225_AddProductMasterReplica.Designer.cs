...
namespace ShopService.Infrastructure.Migrations
{
    ...
    [Migration("20260417170225_AddProductMasterReplica")]
    partial class AddProductMasterReplica
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopService.Domain.Entities.ProductMasterReplica", b =>
                {
                    ...
                    b.ToTable("product_master_replica", (string)null);
                });
            ...
            modelBuilder.Entity("ShopService.Domain.Entities.ShopOrderCounterLedger", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("shop_order_counter_ledger", (string)null);
                });

            modelBuilder.Entity("ShopService.Domain.Entities.ShopProductCounterLedger", b =>
                {
                    b.Property<Guid>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime?>("UncountedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("uncounted_at");

                    b.HasKey("ProductId");

                    b.HasIndex("ShopId");

                    b.ToTable("shop_product_counter_ledger", (string)null);
                });
